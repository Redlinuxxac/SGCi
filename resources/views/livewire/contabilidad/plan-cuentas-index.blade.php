<div>
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Plan de Cuentas</h1>
                ...
                @forelse ($cuentas as $cuenta)
                    <tr wire:key="{{ $cuenta->id }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <button wire:click="edit({{ $cuenta->id }})" class="btn btn-secondary">Editar</button>
                            @endcan
                        </td>
                    </tr>
                @empty
